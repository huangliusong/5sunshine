<%@ Page Language="C#" AutoEventWireup="true" CodeFile="hb.aspx.cs" Inherits="yxzp" %>
...
<body>
    ...
    <asp:DataList ID="DataList1" runat="server" DataKeyField="phid" 
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT * FROM [xiazai] WHERE ([style] = @style2) ORDER BY [zancount] DESC, [download] DESC">
            <SelectParameters>
                <asp:CookieParameter CookieName="tyle" DefaultValue="海报" Name="style2" 
                    Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
    </div>
