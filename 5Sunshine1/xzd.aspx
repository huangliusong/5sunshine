<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xzd.aspx.cs" Inherits="yic" %>
...
<body>
    ...
    <div><asp:DataList ID="DataList1" runat="server" DataKeyField="phid" 
            DataSourceID="SqlDataSource1" RepeatColumns="6" 
            RepeatDirection="Horizontal">
            <ItemTemplate>
               <table>
             <tr><td><table class="xzd" style=" border:1px solid #E6E6E6;"><tr>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            <SelectParameters>
                <asp:SessionParameter DefaultValue="宣传单" Name="style" SessionField="style" 
                    Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
    </div>
